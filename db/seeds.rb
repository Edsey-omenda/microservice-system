...
customer1 = Customer.create(name: "James Omenda", account_type: "Master card", account_number: 11218031720132016, email: "omendajames0317@gmail.com", age: 24, contact:  +254700332508)
customer2 = Customer.create(name: "Harvey Spector", account_type: "Visa card", account_number: 20111217192021239, email: "reginaldspector@gmail.com", age: 38, contact: +111205450)
customer3 = Customer.create(name: "Rachel Zane", account_type: "Master card", account_number: 14589023176009417, email: "rachelezabeth@gmail.com", age: 28, contact:  +254769334509)
customer4 = Customer.create(name: "Lauren Akinyi", account_type: "Rupay card", account_number: 20171819222523119, email: "akinyilosh@gmail.com", age: 25, contact:  +254712097658)
